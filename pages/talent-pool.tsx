...
export default function TalentPool () {
    ...
    const [positionParam, setPositionParam] = useState(positionDataList[0].position);
    const [departmentParam, setDepartmentParam] = useState(positionDataList[0].department);
