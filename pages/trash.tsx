                  ...
                  <div key={department.id}>
                    ...
                    <div className={`flex flex-wrap gap-8 mt-6`}>
                      {positionDataList
                        .filter(
                          (position) =>
                            position.department === department.name && position.isTrash.removedDate !== undefined
                        )
                        .map((positionData) => {
                          ...
                          return (
                            <div
                              key={positionData.id}
                              className={`${
                                idPositionChecked.includes(positionData.id) ? 'border-primary_blue' : ''
                              } border flex flex-col gap-6  w-[440px] h-[308px]  bg-light_neutral_200 rounded p-6 `}
                            >
                              <div className={`flex flex-col gap-[12px]`}>
                                <div className={`flex justify-between`}>
                                  <h2 className={`font-semibold text-2xl text-primary_dark`}>
