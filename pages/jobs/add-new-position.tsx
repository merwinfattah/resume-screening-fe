    ...
    return (
        <Layout>
            <section className={` pt-[19px]`}>
                <div className={`mx-[190px] items-center flex  justify-between w-[1646px] h-[75px] py-[14px] px-4 rounded-md bg-light_neutral_200 drop-shadow z-10`}>
                    ...
                    <div className={`flex gap-[18px] text-dark_neutral_200`}>
                        <button className={`bg-light_neutral_500 py-[14px] px-[10px]`}>Save Draft</button>
                        <button className={`bg-light_neutral_500 py-[14px] px-[10px]`} form="job-detail" type="submit" onSubmit={handleFormSubmit}>Save and Continue</button>
                    </div>
                </div>  
            </section>
            <section className={`container mx-auto flex flex-row mt-[17px] gap-[18px]`}>
                ...
                <div className={`w-[1289px] h-[1025px] rounded-md pb-[40px] bg-light_neutral_200`}>
                    ...
                    <form className={`flex flex-col gap-6`} id="job-detail">
                            ...
                            <div className={`flex gap-[49px]`}>
                                <div className={` w-1/2 h-[113px]`}>
                                    ...
                                    <div className={`flex justify-between items-center mt-[18px] mb-2 py-3 px-4 rounded-md w-[580px] h-[44px] border border-dark_neutral_200`}>
                                        ...
                                        <Select
                                            ...
                                            placeholder="Example : Human Resource"
                                            style={{ backgroundColor: 'transparent'}}
                                            onChange={(value) => handleSelectChange(value, 'department')}
                                            className={`w-full bg-light_neutral_200 `}
                                        >
                                ...
                                <div className={` w-1/2 h-[113px]`}>
                                    ...
                                    <div className={`flex justify-between items-center mt-[18px] mb-2 py-3 px-4 rounded-md w-[580px] h-[44px] border border-dark_neutral_200`}>
                                        <input id="job-position" name="job-position" placeholder="Example : Associate Manager" className={`bg-transparent w-full outline-none`} onChange={handleInputChange}/>
                                    </div>
                                    <p className={`text-dark_neutral_300`}>80 characters left. No special characters.</p>
                                </div>
                            </div>
                            ...
                            <div className={`flex gap-[49px]`}>
                                ...
                                <div className={` w-1/2 h-[113px]`}>
                                    ...
                                    <div className={`flex justify-between items-center mt-[18px] mb-2 py-3 px-4 rounded-md w-[580px] h-[44px] border border-dark_neutral_200`}>
                                        <input id="job-position" name="job-position" placeholder="Example : Jakarta, Bogor, atau Bandung" className={`bg-transparent w-full outline-none`} onChange={handleInputChange}/>
                                    </div>
                    ...
                    <div className={` px-10 pt-[42px]`}>
                        ...
                        <div>
                            <label htmlFor="job-description"><span>*</span>Job Requirement</label>
                            <div>
                              {/* Rich Text Editor */}
