        ...
        <div className={`w-[1198px] bg-light_neutral_200 rounded-md `}>
          ...
          <div className={` py-[32px] px-[40px]`}>
            <form id="candidates-information" className={`flex flex-col gap-[24px]`} onSubmit={handleCandidatesSubmit}>
              ...
              >
                <p>Pastikan untuk mengisi semua kolom di bawah ini dengan informasi kandidat dari CV terkait </p>
              ...
              <div
                className={` h-auto flex justify-between py-[10px] px-[12px] rounded text-semantic_purple_600  bg-semantic_purple_100 border border-semantic_purple_600`}
              >
                <p>Disarankan untuk mengisi domisili kandidat jika lokasi merupakan salah satu faktor rekrutmen Anda</p>
                <div className={`flex gap-3 `}>
                  <p className={`underline`}>jangan tampilkan lagi</p>
                  <button>
                    <GrClose />
              ...
              <div className={` flex gap-[18px]`}>
                <div className={` w-1/2 h-[113px]`}>
                  <label htmlFor={`domicile_${activeFileIndex}`} className={`text-xl font-medium text-primary_dark`}>
                    {' '}
                    Domisili{' '}
                  </label>
                  <div
          ...
          <div>
            <div className={`bg-light_neutral_300 h-[72px] py-[21.5px] border-b-[1px] border-mid_neutral_600`}>
              <h2 className={`font-semibold text-primary_dark text-2xl pl-[24px]`}>Pratinjau CV Kandidat</h2>
            </div>
            <div>
